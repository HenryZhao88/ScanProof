...
README.md cites figures from ``artifacts/``. The document is written by hand;
the artifacts are regenerated by ``make audit`` / ``make shift``. Without this
test, re-running a study would silently leave stale numbers in the submission
copy.
